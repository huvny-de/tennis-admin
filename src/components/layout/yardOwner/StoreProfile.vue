<template>
  <div class="p-8 flex flex-col items-center justify-between">
    ...
    >
      <ul
        v-if="isSelectedTab === 'DisplayProfile'"
        class="
          nav nav-tabs
          flex flex-col
          md:flex-row
      ...
      >
        ...
        <li
          @click="setSelectedTab('UpdateStore')"
          class="nav-item"
          role="presentation"
        >
          <span
      ...
      >
        <li
          @click="setSelectedTab('DisplayProfile')"
          class="nav-item"
          role="presentation"
        >
          <span
...
<script>
import DisplayProfile from "./StoreProfile/DisplayProfile.vue";
import UpdateStore from "./StoreProfile/UpdateStore.vue";
export default {
  components: {
    DisplayProfile,
    UpdateStore
