<template>
  ...
  <div class="dashboard p-8">
    ...
    <div class="wrapper-card md:grid-cols-2 gap-2 overflow-y-auto">
      <div class="w-full mx-auto px-4 h-full flex items-center justify-between relative">
        <!--List Yard-->
        <div class="gird grid-cols-2 gap-6 lg:w-[65%] md:w-full">
          <div>
            <div v-for="courtInfo in courtList" :key="courtInfo.Id"
              ...
              <div class="flex items-center pl-8 w-[72%]">
                <div class="mr-5 w-60 h-40">
                  <img class="w-full h-full rounded-2xl object-contain" :src="
                    courtInfo.ImageUrl
                      ? courtInfo.ImageUrl
                  ...
                  <div class="flex items-center mb-2">
                    ...
                    <div v-if="courtInfo.RatingAverage > 0" class="item-rating">
                      <ul class="unstyled-list list-inline flex items-center">
                        <li v-for="number in Math.floor(courtInfo.RatingAverage)" :key="number"
                        ...
                        <li v-show="
                          ...
                          0.5
                        " class="ratings-list-item">
                          <Icon class="w-5 h-5 text-yellow-300" icon="clarity:half-star-solid"></Icon>
                        </li>
              ...
              <div class="flex-1 w-full h-full border-l-2 p-4">
                <div class="w-full h-full">
                  ...
                  <div class="flex space-x-2 justify-center my-8" @click="showAlert(courtInfo.Id)">
                    <button type="button"
        ...
        <!--Card Report-->
        <div class="max-w-sm rounded overflow-hidden shadow-lg flex-1 absolute top-0 right-0 md:hidden lg:block">
