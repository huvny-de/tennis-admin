<template>
  ...
  <div class="p-8 flex flex-col items-center justify-between">
    <div
      class="mt-2 bg-white dark:bg-gray-800 p-5 w-full px-4 rounded-md box-border shadow"
    >
      <span>
            ...
            >
              ...
              <td class="px-6 py-4">
                <span
                  ...
                  v-if="booking.StatusId == 1"
                >
                  Mới
                </span>
                <span
                  class="text-purple-800 bg-purple-300 px-3 py-1 rounded-md"
                  v-else-if="booking.StatusId == 2"
                >
                  Xác Nhận
                </span>
                <span
                  class="text-purple-800 bg-purple-300 px-3 py-1 rounded-md"
                  v-else-if="booking.StatusId == 3"
                >
                  Chủ Sân Từ Chối
                </span>
                <span
                  class="text-red-800 bg-red-300 px-3 py-1 rounded-md"
                  v-else-if="booking.StatusId == 4"
                >
                  Nguời Dùng Đã Hủy
                </span>
                <span
                  class="text-red-800 bg-red-300 px-3 py-1 rounded-md"
                  v-else-if="booking.StatusId == 5"
                >
                  Đã Thanh Toán
                </span>
                <span
                  class="text-red-800 bg-red-300 px-3 py-1 rounded-md"
                  v-else-if="booking.StatusId == 6"
                >
                  Người Đặt Không Đến
                </span>
              </td>
      ...
      <div
        ...
        class="container mt-4 py-4 flex items-center justify-center"
      >
