  ...
  <div class="
    ...
    <form @submit.prevent="updateProfile">
      ...
      <div class="flex">
        ...
        <div class="flex-1 grid md:grid-cols-2 gap-6 mt-4 sm:grid-cols-1 text-normal">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input placeholder="Tên Tài Khoản" type="text" class="
                        mt-2
                        w-[90%]
                        px-3
                        py-2
          ...
          <div>
            ...
            <!-- <input-component  disabled="true" class="w-full mt-2 border-gray-800 text-sm text-gray-600"
              :value="roleUser" /> -->
            <div class="relative">
              <p v-if="!roleUser" class="text-2xl text-red-500 absolute right-12 top-4">
                *
              </p>
              <input placeholder="Tên Cửa Hàng" type="text" class="
                        ...
                        mb-2
                        pr-8
                      " required disabled v-model="roleUser" />
              <!-- <p v-if="err.errVendorName" class="
                        absolute
                        top-[138%]
                        left-0
          ...
          <div>
            ...
            <!-- <input-component required class="w-full mt-2 text-sm" :value="currentUser.Email" /> -->
            <div class="relative">
