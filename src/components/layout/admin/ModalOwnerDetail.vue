  ...
  >
    ...
    <div class="mx-auto relative p-4 w-full max-w-6xl h-full md:h-auto">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-8">
        <button
          @click="hiddenModal"
          type="button"
          class="
        ...
        <div class="py-6 px-6 lg:px-8">
          <div class="py-4flex flex-col items-center justify-between">
            ...
            >
              <ul
                v-if="isSelectedTab === 'ModalOwnerProfile'"
                class="
                  nav nav-tabs
                  flex flex-col
                  md:flex-row
              ...
              >
                ...
                <li role="presentation">
                  ...
                  >
                    <span class="mx-2 text-[13px] text-[#434141] font-bold"
                      >Thông Tin Chủ Sân</span
                    >
                  </div>
                </li>

                <li
                  @click="setSelectedTab('ModalStoreProfile')"
                  class="nav-item"
                  role="presentation"
                >
                  <span
                  ...
                  >
                    <span
                      class="mx-2 text-[#334D6E] text-[13px] font-medium pt-1"
                ...
                <li
                  @click="setSelectedTab('ModalRentalYardList')"
                  class="nav-item"
                  role="presentation"
                >
                  <span
              ...
              <ul
                v-if="isSelectedTab === 'ModalStoreProfile'"
                class="
                  nav nav-tabs
                  flex flex-col
                  md:flex-row
              ...
              >
                <li
                  @click="setSelectedTab('ModalOwnerProfile')"
                  class="nav-item"
                  role="presentation"
                >
                  <span
              ...
              <ul
                v-if="isSelectedTab === 'ModalRentalYardList'"
                class="
                  nav nav-tabs
                  flex flex-col
                  md:flex-row
