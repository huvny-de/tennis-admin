          ...
          <div class="bg-white p-3 border-t-4 border-green-400">
            <div class="image overflow-hidden">
              <img
                ...
                :src="userProfile.Vendor[0].AvatarUrl"
                alt=""
              />
            </div>
          </div>
            ...
            <div class="text-gray-700 mt-2">
              <div class="grid grid-col">
                <span class="flex items-center">
                  <div class="px-4 font-semibold w-52">Tên Cửa Hàng:</div>
                  <div class="py-2">
                    <div class="px-1">
                      <div class="relative">
                        <div class="px-1 py-1 text-left">
                          {{ userProfile.Vendor[0].VendorName }}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <span class="flex items-center">
                  <div class="pl-4 pr-2 mt-[-25px] font-semibold w-60">
                    Địa chỉ:
                  </div>
                  <div class="px-1 py-2">
                    <div class="px-1 py-1">
                ...
                <span class="flex items-center">
                  <div class="pl-4 pr-2 font-semibold w-52">
                    Khung Giờ Hoạt Động:
                  </div>
                  <div class="px-1 flex items-center">
                    <div class="px-1">
                      <div class="relative">
                        <div class="px-1 py-1 text-left">
                          {{
                            new Date(userProfile.Vendor[0].OpenTime)
                              .toLocaleTimeString()
                              .slice(0, 5)
                          }}
                          -
                          {{
                            new Date(userProfile.Vendor[0].CloseTime)
                              .toLocaleTimeString()
                              .slice(0, 5)
                          }}
                        </div>
                ...
                <span class="flex items-center py-3">
                  <div class="pl-4 pr-2 font-semibold w-44">Email:</div>
                  <div class="px-1">
                    <div class="px-1 pt-1">
                        <div class="relative">
                          <div class="px-1 py-1 text-left">
                            {{ userProfile.Vendor[0].Email }}
                          </div>
                        </div>
                    </div>
                  </div>
                ...
                <span class="flex items-center">
                  <div class="pl-4 pr-2 font-semibold w-44">Số Điện Thoại:</div>
                  <div class="px-1">
                    <div class="px-1">
                        <div class="relative">
                          <div class="px-1 py-1 text-left">
                            {{ userProfile.Vendor[0].PhoneNumber }}
                          </div>
                        </div>
                    </div>
                  </div>
