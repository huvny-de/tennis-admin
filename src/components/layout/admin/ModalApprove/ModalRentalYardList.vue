<template>
  <div class="dashboard">
    ...
    <div class="container h-96 overflow-auto mt-8 px-2">
      <div v-for="court in courtList" :key="court.Id" class="card h-60 w-full bg-white flex items-center  rounded">
        <div class="flex items-center pl-8 w-full">
          ...
          <div class="flex flex-col items-start h-auto mt-7">
            <div class="flex items-start mb-4">
              <span class="text-gray-500 text-md font-semibold mr-5 w-32 mt-1">Tên Sân:
              </span>
            ...
            <div class="flex items-start mb-4">
              <span class="text-gray-500 text-md font-semibold mr-5 w-32 mt-1">Loại Sân:
              </span>
              <span class="text-gray-500 mt-[-4px]">
                <div class="relative">
                  <div v-if='court.TypeId == 1' class="px-1 py-2 text-left">
                    Sân Đất Nện
                  </div>
                  <div v-else-if='court.TypeId == 2' class="px-1 py-2 text-left">
                    Sân Cỏ
                  </div>
                  <div v-else-if='court.TypeId == 3' class="px-1 py-2 text-left">
                    Sân Cứng
                  </div>
                </div>
              </span>
            ...
            <div class="flex items-start mb-4">
              <span class="text-gray-500 text-md font-semibold mr-5 w-32 mt-1">Chiều Dài:
              </span>
              <span class="text-gray-500">

                <div class="relative">
                  <div class="px-1  text-left">
                    <div v-if='court.CourtSizeId == 2' class="px-1 py-1 text-left">
                      40m
                    </div>
                    <div v-else-if='court.CourtSizeId == 3' class="px-1 py-1 text-left">
                      36.57m
                    </div>
                    <div v-else-if='court.CourtSizeId == 4' class="px-1 py-1 text-left">
                      34.75m
                    </div>
                  </div>
            ...
            <div class="flex items-start mb-4">
              <span class="text-gray-500 text-md font-semibold mr-5 w-32 mt-1">Chiều Rộng:
              </span>
              <span class="text-gray-500">
                <div class="relative">
                  <div class="px-1  text-left">
...
export default {
  ...
  mounted() {
    ...
    let params = {
      vendorId: this.userProfile.Vendor[0].Id,
      pageSize: 5,
      query: '',
      currentPage: 1,
    }
